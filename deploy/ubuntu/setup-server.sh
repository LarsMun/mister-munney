...
echo -e "${GREEN}🚀 Munney Ubuntu Server Setup${NC}"
echo "========================================="
echo ""
...
echo -e "${BLUE}📡 Step 1: Checking Docker proxy network...${NC}"
if docker network inspect proxy >/dev/null 2>&1; then
    echo -e "${GREEN}✅ Docker proxy network already exists${NC}"
else
    echo -e "${YELLOW}Creating Docker proxy network...${NC}"
    docker network create proxy
    echo -e "${GREEN}✅ Docker proxy network created${NC}"
fi
echo ""

# Step 2: Create directories
echo -e "${BLUE}📁 Step 2: Creating project directories...${NC}"
...
echo -e "${BLUE}🔑 Step 3: Setting up GitHub SSH keys...${NC}"
...
echo ""
echo -e "${YELLOW}=========================================${NC}"
echo -e "${YELLOW}📋 IMPORTANT: Add this SSH key to GitHub${NC}"
echo -e "${YELLOW}=========================================${NC}"
echo ""
...
echo -e "${BLUE}📥 Step 4: Cloning Munney repository...${NC}"
...
echo -e "${BLUE}⚙️  Step 5: Setting up environment files...${NC}"
...
echo "   Development: https://devmunney.home.munne.me"
echo "   Production:  https://munney.home.munne.me"
echo ""
