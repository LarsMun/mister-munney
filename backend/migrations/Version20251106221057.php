...
final class Version20251106221057 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Add duration_months to budget if it doesn't exist
        $budgetTable = $schema->getTable('budget');
        if (!$budgetTable->hasColumn('duration_months')) {
            $this->addSql('ALTER TABLE budget ADD duration_months INT DEFAULT 2 NOT NULL');
        }
